        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.7fr_0.7fr_0.8fr]">
          <div className="max-w-xl">
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">
              Engineering partner for AI, SaaS, automation, and custom product work.
            </h2>
            <p className="mt-4 max-w-lg text-sm leading-6 text-slate-600">
              CodeTelemetryLab helps product and operations teams ship systems that stay maintainable after
              launch—with clear scope, honest timelines, and a documented handoff.
            </p>
          </div>
